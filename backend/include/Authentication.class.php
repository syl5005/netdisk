<?php
	...
	class Authentication {
		...
		public function login($username, $pw) {
			//用MSSQL来验证登录合法性
			$connect=odbc_connect("Driver={SQL Server};Server=192.168.72.2;Database=xyxxxt","sa","sa");
			$sql="select * from b_zgda where c_xm='".iconv("UTF-8","GBK//IGNORE",$username)."' and c_yhmm='".$pw."'";
			//$sql="select * from b_zgda where c_xm='石林' and c_yhmm='".$pw."'";
